...
class LearnScreen(Screen):
    ...
    def _show_folder_import(self, folder, _first_file):
        ...
        content.add_widget(Label(text='选择中文 SRT（第1步）', font_size='8sp', size_hint_y=None, height=40,
            color=(0.067, 0.078, 0.086, 1)))
        ...
        for s in files:
            btn = Button(text=s, font_size='8sp',
    ...
    def _show_en_srt_selector(self):
        ...
        with content.canvas.before:
            Color(rgba=(1, 1, 1, 1))
            RoundedRectangle(pos=content.pos, size=content.size, radius=[16]*4)
        content.add_widget(Label(text='选择英文 SRT（第2步）', font_size='8sp', size_hint_y=None, height=40,
            color=(0.067,0.078,0.086,1)))
    ...
    def _import_srt_desktop(self):
        ...
        content.add_widget(Label(text='选择 SRT 目录',
            font_size='8sp', size_hint_y=None, height=36, color=(0.067, 0.078, 0.086, 1)))

        pi = TextInput(text=os.path.expanduser('~'), font_size='8sp',
        ...
        cancel = Button(text='取消', font_size='8sp',
            background_normal='', background_color=(0.95,0.95,0.95,1), color=(0.4,0.4,0.4,1))
        select = Button(text='选择中文 SRT', font_size='8sp', bold=True,
...
".join(parts)) if parts else ""
    ...
    def _show_popup(self, title, message):
        ...
        content.add_widget(Label(text=message, font_size='8sp',
            color=(0.067, 0.078, 0.086, 1), halign='center', text_size=(300, None)))
        btn = Button(text='确定', size_hint_y=None, height=44,
            background_normal='', background_color=(0.420,0.565,0.502,1), color=(1,1,1,1), font_size='8sp')
        content.add_widget(btn)
