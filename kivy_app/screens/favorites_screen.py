...
class FavoritesScreen(Screen):
    ...
    def _refresh(self):
        ...
        for i, f in enumerate(favs):
            ...
            row.add_widget(Label(text=f"#{i+1}", font_name='ChineseFont',
                font_size='8sp', color=(0.616,0.643,0.667,1), size_hint_x=None, width=32))
            row.add_widget(Label(text=f["chinese"], font_name='ChineseFont',
                font_size='9sp', color=(0.102,0.110,0.118,1), halign='left'))
            db = Button(text='×', font_size='13sp', color=(0.878,0.345,0.298,1),
            ...
            # English toggle
            eb = Button(text='查看英文 ▸', font_name='ChineseFont', font_size='8sp',
    ...
    def clear_all(self):
        ...
        content.add_widget(Label(text='确定清空所有收藏？', font_name='ChineseFont',
            font_size='8sp', color=(0.067, 0.078, 0.086, 1), halign='center'))
        btns = BoxLayout(size_hint_y=None, height=44, spacing=12)
        cb = Button(text='取消', font_name='ChineseFont', font_size='8sp',
            background_normal='', background_color=(0.953,0.957,0.953,1),
            color=(0.408,0.439,0.471,1))
        ok = Button(text='清空', font_name='ChineseFont', font_size='8sp', bold=True,
