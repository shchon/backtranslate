...
BG_SURFACE = (0.890, 0.898, 0.886, 1)      # #E3E5E2  次级表面(加深)

# ── 文字 ──
TEXT_PRIMARY   = (0.067, 0.078, 0.086, 1)   # #111416  主文字
TEXT_SECONDARY = (0.302, 0.325, 0.349, 1)   # #4D5359  辅助文字
TEXT_MUTED     = (0.420, 0.447, 0.475, 1)   # #6B7279  弱化文字
